...
import com.Alatheer.alatheer.schoole.MVP.ParentLogin.ViewData;
...
public class LoginParentActivity extends AppCompatActivity implements ViewData {
    ...
    private com.Alatheer.alatheer.schoole.MVP.ParentLogin.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter =new com.Alatheer.alatheer.schoole.MVP.ParentLogin.PresenterImp(this,this);
        // getDataFromIntent();
